		...
		<div class="wrap">
			...
			<table border="" cellspacing="" cellpadding="">
				...
				<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><tr>
						...
						<?php if($row['kj_dx'] == 1): ?><td class="jy" style="color: #2466D0;"><span style="color: red;">大</span></td>
						<?php else: ?>
							<td class="jy" style="color: #2466D0;"><span style="color: red;">小</span></td><?php endif; ?>
