        ...
        <div class="form-horizontal" style="height: 400px">
            <form action="<?php echo U('create');?>" method="post" id="dx" enctype="multipart/form-data" onsubmit="return true">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input class="form-control" class="form-control"   name="title" id="title"/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="text" style="width: 100px;" class="form-control" value="" name="fee1" id="fee1" placeholder="单位积分"/>
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputEmail3" class="col-sm-2 control-label">特级价格</label>
                    <div class="col-sm-6">
                        <input type="text" style="width: 100px;" class="form-control" value="" name="fee2" id="fee2" placeholder="单位积分"/>
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputEmail3" class="col-sm-2 control-label">一级价格</label>
                    <div class="col-sm-6">
                        <input type="text" style="width: 100px;" class="form-control" value="" name="fee3" id="fee3" placeholder="单位积分"/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="text" style="width: 100px;" class="form-control" value="" name="number" id="number"/>
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputEmail3" class="col-sm-2 control-label">尺寸</label>
                    <div class="col-sm-6">
                        <input type="text" style="width: 100px;" class="form-control" value="" name="size" id="size" placeholder="X,L,M"/>
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputEmail3" class="col-sm-2 control-label">规格</label>
                    <div class="col-sm-6">
                        <input type="text" style="width: 100px;" class="form-control" value="" name="guige" id="guige" placeholder="包,箱"/>
                    </div>
                </div>
                <div class="form-group">
