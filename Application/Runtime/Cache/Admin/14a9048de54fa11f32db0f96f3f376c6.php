...
<div class="container-fluid main">
    ...
    <div class="main-content well" style="height: 700px;">
        ...
        <div class="form-horizontal" style="height: 400px">
            <form action="<?php echo U('feeBili');?>" method="post" id="dx" enctype="multipart/form-data" onsubmit="return true">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        ...
                        一包&nbsp;<input class="jifen" type="text" name="one" class="inputstyle"  value="1"  placeholder="60" />　积分　=　一箱&nbsp;<input class="jifen" type="text" class="inputstyle" name="two" value="<?php echo ($bili["one"]); ?>"  placeholder=""/>　积分
                        <br/>
                        <br/>
