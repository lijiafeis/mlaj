...
<head>
	...
	<script src="/mlaj/Public/Admin/laypage/laypage.js"></script>
	<script src="/mlaj/Public/Admin/js/xigua.upload.js"></script>
	<script src="/mlaj/Public/Admin/js/ajaxfileupload.js"></script>
	<style>
...
<body style="width:500px;margin:0;padding:10px;">
	<a href="javascript:;" class="file"><input type="file" name="file" id="file" accept="image/jpeg,image/png,image/gif" />上传新图片</a>
