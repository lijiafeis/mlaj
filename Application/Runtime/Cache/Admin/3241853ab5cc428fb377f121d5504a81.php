...
<div class="container-fluid main">
	<div class="main-top"><span class="glyphicon glyphicon-align-left" aria-hidden="true"></span>链接设置</div>
	<div class="main-content well" style="height: 700px;">
		<h5 class="alert alert-success" style="padding:5px 10px;line-height:30px;">链接设置</h5>
		<div class="form-horizontal" style="height: 400px">
			<form action="<?php echo U('setSckUrl');?>" method="post" id="dx" enctype="multipart/form-data" onsubmit="return true">

				<div class="form-group">
					<label for="inputEmail3" class="col-sm-2 control-label">链接地址设置</label>
					<div class="col-sm-6">
						<!--<input type="text" class="form-control"  style="width:30%" name="qf_jine" value="<?php echo ($data['qf_jine']); ?>" placeholder="">-->
						&nbsp;<input class="jifen" type="text" name="url" class="inputstyle"  value="<?php echo ($url['url']); ?>"  placeholder="" />　
						<br/>
						<br/>
						<!--单片&nbsp;<input class="jifen" type="text" name="three" class="inputstyle"  value="1"  placeholder="60" />　积分　=　包&nbsp;<input class="jifen" type="text" class="inputstyle" name="four" value="<?php echo ($bili["two"]); ?>"  placeholder=""/>　积分-->
						<!--<br/>-->
						<!--<br/>-->
					</div>
