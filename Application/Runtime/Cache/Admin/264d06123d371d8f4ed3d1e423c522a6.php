...
<div class="container-fluid main">
	...
	<div class="main-content well"  style="margin-top:30px;border:1px solid #dddddd;padding:10px 2%;">
		<form class="form-horizontal" action="/Admin/Base/config.html" method="post" enctype="multipart/form-data" >
		 ...
		 <div class="form-group">
			<label class="col-sm-12   col-lg-12 text-left"  for="inputEmail3"> 上传证书</label>
			<div class="col-sm-4  col-lg-2">
				<input type="file" id="file1" class="form-control" id="" name="file1" value="<?php echo ($info[0]['']); ?>" placeholder="" >
				<span id="" class="help-block">上传apiclient_cert.pem</span>
			</div>
			<div class="col-sm-4  col-lg-2">
				<input type="file" id="file2" class="form-control" id="" name="file2" value="<?php echo ($info[0]['']); ?>" placeholder="" >
				<span id="" class="help-block">上传apiclient_key.pem</span>
			</div>
			<div class="col-sm-4  col-lg-2">
				<input type="file" id="file3" class="form-control" id="" name="file3" value="<?php echo ($info[0]['']); ?>" placeholder="" >
				<span id="" class="help-block">上传rootca.pem</span>
			</div>					
		</div><div style="clear:both"></div>
		<div class="form-group">
			<label for="inputEmail3" class="col-sm-12">证书在商户平台和微信支付开通邮件中都可下载，若证书已上传，无需重复上传</label>
		</div>
